...
return [
        ...
        'controllers' => [
                'factories' => [
                        ...
                        Controller\AuthController::class => function(\Interop\Container\ContainerInterface $container, $requestedName) {
                            $tableGateway = $container->get('Application\Model\UserTableGateway');
                            $sessionContainer = $container->get('ContainerNamespace');
                            $controller = new Controller\AuthController($tableGateway, $sessionContainer);
                            return $controller;
                        },
                ],
        ],
